...
set -U fish_user_paths $HOME/.bun/bin $HOME/.cargo/bin $HOME/.emacs.d/bin $HOME/.bin $HOME/.local/bin $HOME/Applications $fish_user_paths /usr/local/go/bin $HOME/.yarn/bin $HOME/software/flutter/bin $HOME/.local/share/nvm/v16.15.0/bin $HOME/scripts
...
set fish_pager_color_progress brwhite --backgrounddd=cyan
set fish_color_search_match --background="#60AEFF"

source $FLINE_THEME_DIR/default_symbols.fish
# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
eval /home/glenn/anaconda3/bin/conda "shell.fish" "hook" $argv | source
# <<< conda initialize <<<


# Bun
set -Ux BUN_INSTALL "/home/glenn/.bun"
set -px --path PATH "/home/glenn/.bun/bin"
